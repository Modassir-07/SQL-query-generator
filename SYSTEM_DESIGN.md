...
- OpenAI SDK (used as an OpenAI-compatible client for the Gemini API)
- SQLite (Database)
- Python 3.13
...
1. **No LangChain Dependency**: Direct OpenAI-compatible SDK usage (pointed at Gemini) for maximum control
